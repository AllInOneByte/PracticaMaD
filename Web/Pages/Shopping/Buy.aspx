        ...
        <form id="BuyForm" method="POST" runat="server">
            <div class="field">
                ...
                <div class="field">
                    ...
                    <br />
                    <span class="label">
                        <asp:Localize ID="lclDescription" runat="server" meta:resourcekey="lclDescription" /></span><span class="entry">
                ...
                <div class="field">
                    <span class="label">
                        <asp:Localize ID="lclTotal" runat="server" meta:resourcekey="lclTotal" /></span><span class="entry">
